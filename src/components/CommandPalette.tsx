...
const SEARCH_ITEMS: SearchItem[] = [
  {
    ...
    category: 'Tool',
    description: 'Book a 10-minute holiday photo session with your loved one at Ashton Medical Lodge.',
    url: '/',
    icon: Calendar,
  },
  {
    ...
    category: 'Tool',
    description: 'Switch your 10-minute photo shoot appointment to an open slot without calling reception.',
    url: '/reschedule',
    icon: Calendar,
  },
  {
